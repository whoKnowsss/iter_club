...
<div id="userforum"></div>
    ...
    <div class="main layui-clear">
        <div class="fly-main layui-clear">
            ...
            <div class="home-left">
                ...
                <ul class="home-jieda">
                    ...
                    <li>
                        <p>
                            <span>{{item.time}}</span>
                            在<a href="${ctx}/forum/questions/detail?id={{ item.id }}" target="_blank">{{= item.title||'求解'}}</a>中回答：
                        </p>
            ...
            <script id="userforum-rightscript" type="text/html">
                {{#
                var info = d || {};
                }}
...
<script>
    $.get("/forum/user/getbyid", { //个人资料
        ...
        layui.use(['jquery', 'laytpl'], function () {
            ...
            var getTpl = $("#userforum-rightscript").html();
            laytpl(getTpl).render(obj.Result, function (html) {
                $("#userforum-right").html(html);
            });
        });
    });
